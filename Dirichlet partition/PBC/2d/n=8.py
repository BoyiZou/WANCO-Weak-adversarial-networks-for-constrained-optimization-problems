...
def main():
    ...
    params["d"] = 2
    params["dd"] = 8
    params["bodyBatch"] = 30000 
    params["lr"] = 0.032 
    params["width"] = 100 
    params["depth"] = 3 
    params["trainStep"] = 30000
    params["penalty"] = 300000 
    params["alpha"] = 1.0003
    params["volumn"] = 1
    params["penalty2"] = 100
    params["writeStep"] = 50
    ...
    params["milestone"] = [300,1000,2000,3000,5000,6000,7000,8000,9000,10000,11000,12500,14000,15000,16000,17000,18000,19500,22500,24000,26000,28000,29000,33000,35000,37000,39000]
    params["gamma"] = 0.5
    params["decay"] = 0.0001
